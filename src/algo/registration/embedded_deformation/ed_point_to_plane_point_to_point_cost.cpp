...
#include "ed_point_to_plane_cost_functions.h"
										   ...
										   const Point & target_point)
{
	...
	auto cost_function = ED::FitPointToPointCostFunction::Create(target_point, deformed_mesh.point(v), global.position(),
										   ...
										   const Vector & target_normal)
{
	auto n_w_vector = deformed_mesh.nearestNodes(v).node_weight_vector;
	auto & global = deformation_graph._global;
	auto cost_function = ED::FitPointToPlaneCostFunction::Create(target_point, target_normal,
