...
std::vector<Point> EmbeddedDeformationFitCostWithoutICP::getFixedPostions()
{
...
EmbeddedDeformationFitCostWithoutICP::ResidualIds
EmbeddedDeformationFitCostWithoutICP::addFitCostVertex(ceres::Problem & problem,
...
EmbeddedDeformationFitCostWithoutICP::VertexResidualIds
EmbeddedDeformationFitCostWithoutICP::addFitCost(ceres::Problem &problem,
											   DeformationGraph<EDDeformation> & deformation_graph,
											   DeformedMesh<DeformationGraph<EDDeformation>> & deformed_mesh,
...
EmbeddedDeformationFitCostWithoutICP::EmbeddedDeformationFitCostWithoutICP(SurfaceMesh & target,
