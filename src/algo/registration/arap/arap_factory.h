...
public:
	...
	SurfaceMesh deformationGraphMesh(const DG::DeformationGraph & deformation_graph);
	SurfaceMesh deformedMesh(const SurfaceMesh & mesh, const DG::DeformationGraph & deformation_graph);
	SurfaceMesh inverseDeformedMesh(const SurfaceMesh & mesh, const DG::DeformationGraph & deformation_graph);
