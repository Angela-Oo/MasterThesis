...
void ShowTwoRigideRegisteredFrames::init(ml::ApplicationData &app)
{
	...
	auto points_frame_B = sensor_data->getPoints(4);


	auto points_icp_A = points_frame_A;
	auto points_icp_B = points_frame_B;
	auto transformation = pointToPointSE3(points_frame_A, points_frame_B);
	auto translation = ml::mat4f::translation({ 200.f, 0., 0. });
