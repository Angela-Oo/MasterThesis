...
KinectSensor::KinectSensor(unsigned int windowWidth, unsigned int windowHeight)
{
	...
	DepthSensor::init(windowWidth, windowHeight, depthWidth, depthHeight, colorWidth, colorHeight);
