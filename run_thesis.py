...
base_args = [exe_path, "--image_folder_name", "images/run_2019_10_08", "--fit", "1.0", "--smooth", "3.0", "-p", "0.1", "-e", "0.095", "--max_iterations", "50"]
...
adaptive_rigidity_args = ["--adaptive_rigidity", "--rigidity_cost_coefficient", "0.005", "--minimal_rigidity_weight", "0.1"]
