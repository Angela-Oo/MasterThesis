...
list_args= []
#base_args = [exe_path, "--image_folder_name", "images/run_2019_09_28", "--fit", "1.0", "--smooth", "5.0", "-p", "0.25", "-e", "0.09"]
#base_args = [exe_path, "--image_folder_name", "images/run_2019_09_28", "--fit", "1.0", "--smooth", "5.0", "-p", "0.20", "-e", "0.08"]
...
refinement_args = ["--refine_deformation_graph", "--min_edge_length_percentage_of_area", "0.01", "--levels", "3", "--smooth_cost_threshold", "0.1", "--smooth_cost_percentage_of_max", "0.9"]
