...
list_args= []
base_args = [exe_path, "--image_folder_name", "images/run_2019_09_10"]
...
refinement_args = ["--refine_deformation_graph"]
...
adaptive_rigidity_args = ["--adaptive_rigidity", "--fit", "5.0", "--smooth", "1.0", "--rigidity_cost_coefficient", "0.01", "--max_iterations", "25"]
adaptive_rigidity_vertex_args = ["--adaptive_rigidity", "--rigidity_coefficient_per_vertex", "--fit", "5.0", "--smooth", "1.0", "--rigidity_cost_coefficient", "0.01", "--max_iterations", "25"]
