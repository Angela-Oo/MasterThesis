...
base_args = [exe_path, "--image_folder_name", "images/run_2019_10_03_max_iterations_50_min_rigidity_0_01", "--fit", "1.0", "--smooth", "3.0", "-p", "0.1", "-e", "0.095", "--max_iterations", "50"]
...
refinement_args = ["--refine_deformation_graph", "--min_edge_length_percentage_of_area", "0.02", "--levels", "3", "--smooth_cost_threshold", "0.1", "--smooth_cost_percentage_of_max", "0.9"]
...
reduce_rigidity_args = ["--reduce_rigidity", "--minimal_rigidity", "0.01", "--rigidity_cost_threshold", "0.01"]

adaptive_rigidity_args = ["--adaptive_rigidity", "--rigidity_cost_coefficient", "0.02", "--minimal_rigidity_weight", "0.01"]
